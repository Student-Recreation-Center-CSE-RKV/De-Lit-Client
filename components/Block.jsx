...
export default function Block({name, image_link, content, link, isActive}) {
  ...
  return (
    <div className={clsx("min-h-[85vh] flex items-center justify-center sticky top-[15vh] overflow-x-hidden transition-opacity duration-100 overflow-hidden", blockClasses)}>
