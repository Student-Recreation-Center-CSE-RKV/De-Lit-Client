...
export default function Block() {
  return (
    <div className="flex md:flex-row lg:space-x-24 m-20 items-center flex-col md:space-x-10 space-y-12">
      <div className="relative md:w-1/3 flex flex-col items-center text-center">
          ...
          <span className="absolute -bottom-6 text-5xl md:top-[calc(14%)] md:left-3/4 lg:text-8xl md:text-5xl tracking-widest bg-gradient-to-br from-black to-colorC bg-clip-text text-transparent">MAGAZINES </span>
      </div>
