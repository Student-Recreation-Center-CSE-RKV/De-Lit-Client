...
export default function Card({character}) {
  ...
  return (
    <>
    <div className="flex flex-col gap-5 items-center justify-between lg:w-[30%] sm:w-[40%] w-[90%]
    ...
    >
        <img src={character.image_link} alt={character.name} className="w-full h-[200px] object-cover rounded-lg" />
        <p className="text-colorB xl:text-lg text-base text-center">{character.quote}</p>
